            ...
            <nav className="mt-4 flex-grow overflow-y-auto">
              <ul className="space-y-2 ">
                {[
                  ...
                  { to: "/admin/edit-about", label: "Редактировать О нас" },
                  { to: "/admin/edit-offer-agreement", label: "Редактировать Соглашение оферта" },
                  { to: "/admin/edit-privacy-policy", label: "Редактировать Политика конфиденциальности" },
                  { to: "/admin/edit-user-agreement", label: "Редактировать Пользовательское соглашение" },
                  { to: "/admin/edit-delivery-rules", label: "Редактировать Правила Доставки" },
                  { to: "/admin/edit/contact-us", label: "Редактировать Контакты" },
                  { to: "/admin/edit-main-image", label: "Редактировать Главное Изображение" },
                  { to: "/admin/edit-main-logo", label: "Редактировать логотип" }
