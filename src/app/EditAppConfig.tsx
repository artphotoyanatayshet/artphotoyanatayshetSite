            ...
            {loading ? (
                ...
                <div className="flex flex-col space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            value={appConfig?.TOKEN_TELEGRAM || ''}
                            onChange={(e) => handleChange('TOKEN_TELEGRAM', e.target.value)}
                            className="w-full p-2 border rounded-md"
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            value={appConfig?.CHAT_ID_TELEGRAM || ''}
                            onChange={(e) => handleChange('CHAT_ID_TELEGRAM', e.target.value)}
                            className="w-full p-2 border rounded-md"
