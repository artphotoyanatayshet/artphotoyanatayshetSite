...
const OfferAgreementEditor = () => {
    return (<>
    <div className="bg-gray-100 mt-12">
    <h1 className="p-10 text-4xl font-bold text-gray-800">{textJsonRu.offer_agreement.title}</h1>
    <TextEditorSaveGit path="public/fragmentOfferAgreement.html" />
    </div>
    <Link
          to="/"
...
export default OfferAgreementEditor;